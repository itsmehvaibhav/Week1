var prompttest = require("prompt-sync")();
console.log("welcome HELLO IN Array PROGRAM");
console.log("which method do you want to run in string method");
console.log("1.concat() Method  2. every() Method  3.filter() Method 4.forEach () Method 5. map() Method 6. pop() Method 7. push() Method 8. reduce() Method 9. reduceRight() Method 10. reverse() Method 11. sliced() Method 12. toSource() Method ");
var y = parseInt(prompttest("enter the no which method do you want to run"));
switch (y) {
    case 1:
        console.log("'''''''''''''''''''''''''''''''''''''''''''''''''''");
        var myinputarr = [];
    ...
    case 11:
        console.log("'''''''''''''''''''''''''''''''''''''''''''''''''''");
        var arrtest2 = ["orange", "mango", "banana", "sugar", "tea"];
